...
parser.add_argument('--batch_size_cls', type=int, default=10, help='size of the batches of class')
...
for epoch in range(start_epoch, opt.end_epoch):
    ...
    # save netG_A2B
    save_checkpoint(netG_A2B, 'netG_A2B', modelroot, epoch+1, optimizer_G, lr_scheduler_G)
    # save netG_B2A
